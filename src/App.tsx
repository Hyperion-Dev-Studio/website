...
// ----------------------------
// UI primitives (typed, no Tailwind)
// ----------------------------
        ...
        <div className="container grid-2 hero">
          <div>
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="lead">Hyperion Dev Studio crafts polished, performant mobile applications for teams who care about detail. Our flagship apps blend logic, polish, and delightful micro-interactions.</p>
        ...
        <div className="container">
          <div className="grid-2 v-center gap-lg">
            <div>
              ...
              <p className="muted-p">Logiquiz trains pattern recognition, deduction, and creative reasoning through bite-sized challenges. Designed for focus, built for flow.</p>
...
.site { position:relative; min-height:100vh; color: var(--text); background:
...
.brand-icon{display:flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:14px;background:linear-gradient(135deg,var(--main),var(--main-2));color:#fff;box-shadow:0 10px 30px rgba(0,0,0,0.12)}
